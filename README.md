...
**Текущая версия:** v2.1.0 — исправления исполнителя, геолокация при входе, сворачиваемые фильтры на мобильных, стабильность CV и сервера.
...
- Координаты кэшируются в `localStorage`; при завершении заявки обновляются без повторного диалога (если разрешение уже выдано).
