...
### 7.4 Мобильные вкладки исполнителя (v2.2.0)
...
- Блок «Фильтры» для исполнителя на мобильных **скрыт** — статус выбирается вкладкой.
...
Константа `EXECUTOR_MOBILE_TABS` и хелперы — в `client/src/utils.js`, компонент `ExecutorMobileTabs` — в `Tasks.jsx`.
...
- **Вкладки исполнителя** (v2.2.0): на мобильных у исполнителя — горизонтальные вкладки по статусам со счётчиками вместо фильтров
