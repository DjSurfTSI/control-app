...
Версия: **v1.3.7** (Integration API **v1** — контракт без изменений)
...
| v1.3.6 | 2026-06-06 | UI поля «Дата» в веб-клиенте; контракт Integration API без изменений |
| v1.3.5 | 2026-06-06 | Исправление офлайн-синхронизации в веб-UI; контракт Integration API без изменений |
| v1.3.4 | 2026-06-06 | Исправление UI поля «Дата»; контракт Integration API без изменений |
| v1.3.3 | 2026-06-06 | Safe-area для PWA на iOS; контракт Integration API без изменений |
| v1.3.2 | 2026-06-06 | Исправление загрузки фото в веб-UI; контракт Integration API без изменений |
